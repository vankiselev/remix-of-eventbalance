-- Fix remaining "RLS Policy Always True" warnings for audit log INSERT policies
-- Scope inserts through parent tables to enforce tenant isolation

-- ============================================================
-- 1. invitation_audit_log: scope INSERT via parent invitations
-- ============================================================
...
-- ============================================================
-- 2. financial_audit_log: scope INSERT via parent transactions
-- ============================================================
