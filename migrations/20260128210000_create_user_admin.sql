...
-- Назначаем роль админа через user_role_assignments
INSERT INTO public.user_role_assignments (user_id, role_id)
SELECT u.id, rd.id
FROM auth.users u, public.role_definitions rd
WHERE u.email = 'a@a.com' AND rd.name = 'admin'
