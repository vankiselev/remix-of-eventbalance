...
DROP POLICY IF EXISTS "Users can view chats they participate in" ON public.chat_rooms;
DROP POLICY IF EXISTS "Users can view chats they participate in" ON public.chat_rooms;
...
DROP POLICY IF EXISTS "Active users can create chat rooms" ON public.chat_rooms;
DROP POLICY IF EXISTS "Active users can create chat rooms" ON public.chat_rooms;
...
DROP POLICY IF EXISTS "Chat admins can update chat rooms" ON public.chat_rooms;
DROP POLICY IF EXISTS "Chat admins can update chat rooms" ON public.chat_rooms;
...
DROP POLICY IF EXISTS "Chat creators and admins can add participants" ON public.chat_participants;
...
DROP POLICY IF EXISTS "Users can view attachments in their chats" ON public.message_attachments;
...
DROP POLICY IF EXISTS "Users can view read status in their chats" ON public.message_read_status;
...
DROP POLICY IF EXISTS "Users can view attachments in their chats" ON storage.objects;
CREATE POLICY "Users can view attachments in their chats"
