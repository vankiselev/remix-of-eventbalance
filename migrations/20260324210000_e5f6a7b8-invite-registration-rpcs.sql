-- Create missing RPCs for invite registration flow
-- 1. get_invitation_for_registration - full invitation lookup for edge function
-- 2. accept_invitation_for_registration - mark invitation as accepted
-- Idempotent

-- 1. Full invitation lookup for registration (returns tenant_id, invited_by etc)
...
-- 2. Accept invitation atomically
