-- Fix approve_pending_user_membership: profiles may not have tenant_id on self-hosted
-- Look up tenant from invitation directly instead
...
BEGIN
  -- Find tenant from invitation (profiles.tenant_id may not exist)
