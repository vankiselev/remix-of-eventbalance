...
import { Package, FileText, CheckSquare, BarChart3, ClipboardList } from "lucide-react";
...
import { WarehouseInventoryPage } from "./warehouse/WarehouseInventoryPage";
      ...
      <div className="space-y-6 w-full overflow-x-hidden">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="inventory" className="mt-6">
            {activeTab === "inventory" && <WarehouseInventoryPage />}
          </TabsContent>
